...
# Walker Ward
# Last Modified: September282, 2018 
# ---------------------------------------
...
def print_hand(hand_as_list): ##this function prints each hand based on the output format and grabs info from the evaluate hand function
    ...
    if(len(hand_as_list) != 0):
        points = 0;
        outputFile.write("Cribbage Hand \n");
        outputFile.write("------------- \n" );
        print("Cribbage Hand");
        print("-------------");
        ...
        for i in range(3):
            ...
            outputFile.write(str(cardN));
            outputFile.write(": ");
            outputFile.write(str(num));
            outputFile.write(" of ");
            outputFile.write(str(card));
            outputFile.write("\n");
        print("Points scored:", points);
        print("");    
        outputFile.write("Points scored: ")
